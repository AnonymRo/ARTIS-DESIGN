...
<body>
    ...
    <div class="description-container">
        <div class="presentation-picture">
            <img src="./Photos/Project12/COVER.jpg">
        </div>
        <div class="interior-text">
            ...
            <p> Două băi în stil French, fiecare plină de personalitate și rafinament, în care tapetul și plăcile mici
                ...
                prospețime și vitalitate încăperii.
                Restul pereților sunt îmbrăcați cu plăci mici de faianță, într-o nuanță de verde, dispunerea lor fiind
                un mozaic delicat care reflectă lumina într-un mod elegant.
                Acest contrast între tapetul cu motive vegetale și faianța luminoasă conferă băii o atmosferă calmantă,
                dar rafinată, cu un aer de grădină de vară în stil franțuzesc.
                ...
                Contrastul între acest tapet închis și plăcile mici de faianță, într-un alb perlat, este unul deosebit
                de elegant.
                Faianța este aranjată într-un model clasic, cu plăci de dimensiuni mici ce adaugă textură pereților și
                reflectă perfect lumina ambientală.
                Detaliile metalice, cum ar fi robinetele aurii și lămpile vintage, dau un aer de lux discret.
                Ambele băi, cu tapetul lor distinctiv și plăcile mici de faianță, captează esența stilului French – un
                echilibru perfect între eleganța clasică și detaliile moderne.
                De la tapetul cu frunze ce adaugă un strop de naturalețe, până la nuanțele calde și sofisticate ale băii
                cu tapet maro, fiecare spațiu devine un loc de refugiu și relaxare, ideal pentru a te răsfăța în fiecare
                zi.
    ...
    <div class="grid-container">
        ...
        <div class="interior-container">
            ...
            $sql = "SELECT Img_Dir FROM Project13";
