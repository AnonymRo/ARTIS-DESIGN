...
<body>
    ...
    <div class="description-container">
        <div class="presentation-picture">
            <img src="./Photos/Project10/Terasa/COVER.jpg">
        </div>
        <div class="interior-text">
            <h2>NUCET Country Club I</h2>
            <p> Sala de evenimente este un spațiu deschis și aerisit, unde stilul country-modern-industrial se îmbină
                armonios pentru a crea o atmosferă unică. Lemnul este elementul central al designului, fiind utilizat
                atât în structura tavanului cu grinzi expuse, cât și în mobilierul robust, aducând o căldură naturală și
                primitoare. <br><br>

                Relația interior-exterior este esențială, iar aceasta este evidențiată de ferestrele mari și ușile
                glisante din sticlă, care permit o legatură continuă cu natura din jur. Spațiul se deschide ușor către
                terasa înconjurătoare, unde lemnul brut și vegetația luxuriantă creează un cadru natural, perfect pentru
                evenimente în aer liber sau semi-acoperite. <br><br>

                Băile oferă o experiență specială, cu un design ce te duce cu gândul la o cabană modernă în mijlocul
                naturii. Tapetul, piatra naturală și elementele de decor inspirate de exterior îți dau senzația că ești
                într-un spațiu integrat în peisaj, iar luminile difuze amplifică această conexiune cu mediul exterior.
                <br><br>

                Întregul spațiu este o invitație la relaxare, îmbinând confortul modern cu simplitatea rustică, creând
                astfel o ambianță perfect echilibrată între exterior și interior, între natură și design industrial.
            </p>
        </div>
    </div>
    ...
    <div class="grid-container">
        ...
        <div class="interior-container">
            ...
            $sql = "SELECT Img_Dir FROM Project10";
