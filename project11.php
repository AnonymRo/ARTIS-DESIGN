...
<body>
    ...
    <div class="description-container">
        ...
        <div class="interior-text">
            ...
            <p> Sala de evenimente reprezintă o fuziune rafinată de stiluri country-modern-industrial, cu un design care
                pune în valoare arhitectura existentă, integrând armonios elemente naturale și contemporane. Un punct
                focal al spațiului este tavanul din lemn, o piesă statement care aduce o textură calda și autentică,
                contrastând cu liniile industriale ale structurilor metalice expuse și cu detaliile minimaliste din
                mobilier. <br><br>

                Băile surprind prin conceptul de „natură în interior”, folosind un tapet cu tematică de padure, ce
                adaugă o senzație de imersiune în peisajul natural. În acest mod, se păstrează o continuitate între
                interior și exterior, oferind un refugiu de liniște în mijlocul amenajării. <br><br>

                La etaj, lounge-ul moody este gândit ca un spațiu intim și atmosferic, cu o cromatică în tonuri închise,
                texturi de catifea și texturi calde de lemn, care creează o ambianță relaxantă și primitoare. Designul
                interior folosește un mix de materiale tactile și finisaje brute, invitând la socializare sau la momente
                de contemplare într-o atmosferă mai calmă și sofisticată. <br><br>

                Întreaga amenajare reușește să păstreze un echilibru fin între rusticitatea autentică și modernitatea
                urbană, fiind un spațiu versatil, perfect pentru evenimente cu personalitate, fie ele elegante,
                corporate sau casual.
            </p>
        </div>
    </div>
