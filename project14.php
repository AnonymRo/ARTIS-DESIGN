...
<body>
    ...
    <div class="description-container">
        ...
        <div class="interior-text">
            ...
            <p>Acest apartament este amenajat cu o paletă de nuanțe subtile de gri, crem și bej, creând un ambient cald,
                elegant și rafinat.
                Alegerea acestor tonuri neutre a fost gândită pentru a maximiza luminozitatea și a oferi senzația de
                spațiu deschis.
                Finisajele de calitate și detaliile atent alese contribuie la un design modern și funcțional, perfect
                adaptat stilului de viață urban.
                <br><br>
                Prin combinarea nuanțelor de gri și crem, s-a reușit un echilibru perfect între confortul vizual și
                eficiența utilizării fiecărui colț de apartament.
                Acest design minimal și luminos nu doar că îmbunătățește aspectul estetic al locuinței, dar optimizează
                și iluminarea naturală, oferind un ambient plăcut pe tot parcursul zilei.
                <br><br>
                Fiecare detaliu a fost gândit pentru a pune în valoare spațiul disponibil și pentru a oferi un cămin
                primitor, unde fiecare element își are locul său perfect.
                Ideal pentru cei care apreciază un stil de viață modern, fără compromisuri în ceea ce privește confortul
                și funcționalitatea.
            </p>
        </div>
    </div>
    ...
    <div class="grid-container">
        ...
        <div class="interior-container">
            ...
            $sql = "SELECT Img_Dir FROM Project14";
